...
def test(opt):
    ...
    return resave(train_names,valid_names, result_matrix,save_dir,back_img,nmatcls_img,subt_img,opt.save_inc_img,iou_conf_scatter)


def valid(train_opt,save_path,train_data=None):
    class MyClass:
        def __init__(self,train_opt,save_path,train_data):
    ...
    opt=MyClass(train_opt,save_path,train_data)        
